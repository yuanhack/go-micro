// Package kubernetes taken from https://github.com/macheal/go-micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/macheal/go-micro/v2/util/kubernetes/client"
